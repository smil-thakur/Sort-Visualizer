(async () => {
    const renderer: HTMLCanvasElement | null = document.getElementById("renderer") as HTMLCanvasElement | null;
    const goBTN: HTMLButtonElement | null = document.getElementById("go") as HTMLButtonElement | null;
    const arrayText: HTMLTextAreaElement = document.getElementById("array") as HTMLTextAreaElement;
    const unsortBtn: HTMLButtonElement = document.getElementById("unsort") as HTMLButtonElement;
    const stopBtn: HTMLButtonElement = document.getElementById("stop") as HTMLButtonElement;
    const loadingDiv: HTMLElement = document.getElementById("sorting-indicator") as HTMLElement;
    const rangeSlider: HTMLInputElement = document.getElementById("sleepRange") as HTMLInputElement;
    const sleepValue: HTMLElement = document.getElementById("Sleepvalue") as HTMLElement;
    ...
    const cHeight = renderer?.height!;
    const cWidth = renderer?.width!;
    ...
    goBTN?.addEventListener("click", async () => {
        var selectedValue: HTMLInputElement | null = document.querySelector('input[name="sort"]:checked') as HTMLInputElement
    ...
    const drawBlock = (x: number, height: number, width: number, color?: string) => {
    ...
    const merge = async (arr: number[], start: number, middle: number, end: number) => {
    ...
    const drawAllBlocks = async (arr: number[], color?: string, wait: boolean = true) => {
